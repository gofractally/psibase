...
echo =====
${DOCKER} bash -c "cargo generate -p ./package-templates/ --destination ./packages/user/ --init -v --name Buildtest --silent basic-01 && cd packages/user/Buildtest && ${WORKSPACE_ROOT}/build/rust/release/cargo-psibase package"
