...
echo =====
${DOCKER} bash -c "./package-templates/generate-package.sh buildtest 'CI build test' && cd packages/user/Buildtest && ${WORKSPACE_ROOT}/build/rust/release/cargo-psibase package"
