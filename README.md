...
| Rust toolchain | 1.86            | Develop programs in Rust. Use `cargo` to install `cargo-component`, `sccache`, and `wasm-pack`. Tools like `mdbook` and its preprocessors are auto-installed by CMake during configuration. |
