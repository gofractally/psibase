...
namespace psibase
{
   ...
   {
      REQUIRE(                         //
          psibase::show(               // if show is false, nothing is printed
              show,                    // if show is true or failure then pretty print
              t.push_transaction(      //
                  t.make_transaction(  //
                      {
                          {
