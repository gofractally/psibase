...
void FractallySys::init()
{
   ...
   // auto tokContract = at<FractallySys>();
...
// TID FractallySys::create(Precision precision, Quantity maxSupply)
// {
...
//    if (creator != FractallySys::contract)
//    {
...
// void FractallySys::mint(TID tokenId, Quantity amount, const_view<String> memo)
// {
...
// void FractallySys::burn(TID tokenId, Quantity amount)
// {
//    auto sender  = getSender();
//    auto token   = getToken(tokenId);
//    auto balance = getBalance(tokenId, sender);
...
// void FractallySys::setUserConf(psibase::NamedBit_t flag, bool enable)
// {
//    auto sender  = getSender();
...
// void FractallySys::setTokenConf(TID tokenId, psibase::NamedBit_t flag, bool enable)
// {
//    check(_isSenderIssuer(tokenId), missingRequiredAuth);
...
// void FractallySys::credit(TID tokenId, AccountNumber receiver, Quantity amount, const_view<String> memo)
// {
//    auto sender      = getSender();
//    auto balance     = getBalance(tokenId, sender);
//    auto token       = getToken(tokenId);
...
// void FractallySys::uncredit(TID                tokenId,
...
// void FractallySys::debit(TID tokenId, AccountNumber sender, Quantity amount, const_view<String> memo)
// {
...
// void FractallySys::recall(TID tokenId, AccountNumber from, Quantity amount, const_view<String> memo)
// {
//    auto sender          = getSender();
//    auto token           = getToken(tokenId);
...
// void FractallySys::mapSymbol(TID tokenId, SID symbolId)
// {
//    auto sender      = getSender();
...
// TokenRecord FractallySys::getToken(TID tokenId)
// {
//    auto tokenTable = db.open<TokenTable_t>();
//    auto tokenIdx   = tokenTable.getIndex<0>();
...
// SID FractallySys::getTokenSymbol(TID tokenId)
// {
//    auto token = getToken(tokenId);
...
// bool FractallySys::exists(TID tokenId)
// {
//    return db.open<TokenTable_t>().getIndex<0>().get(tokenId).has_value();
// }

// BalanceRecord FractallySys::getBalance(TID tokenId, AccountNumber account)
// {
//    auto balanceTable = db.open<BalanceTable_t>();
...
// SharedBalanceRecord FractallySys::getSharedBal(TID           tokenId,
...
// TokenHolderRecord FractallySys::getTokenHolder(AccountNumber account)
// {
...
// bool FractallySys::getUserConf(psibase::AccountNumber account, psibase::NamedBit_t flag)
// {
...
// bool FractallySys::getTokenConf(TID tokenId, psibase::NamedBit_t flag)
// {
//    auto token     = getToken(tokenId);
//    auto flagIndex = TokenRecord::Configurations::getIndex(flag);
...
// void FractallySys::_checkAccountValid(psibase::AccountNumber account)
// {
//    check(at<AccountSys>().exists(account), invalidAccount);
//    check(account != AccountNumber{0}, invalidAccount);
// }

// bool FractallySys::_isSenderIssuer(TID tokenId)
// {
//    auto token       = getToken(tokenId);
//    auto nftContract = at<NftSys>();
