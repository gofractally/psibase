...
namespace psibase
{
   ...
   using display_name_table_t = table<display_name_row, &display_name_row::acc>;

   using tables = contract_tables<display_name_table_t>;
   class name_sys : public psibase::contract
   {
     public:
      static constexpr psibase::account_num contract     = 102;
      static constexpr std::string_view     account_name = "name.sys";
   ...
   // clang-format off
   PSIO_REFLECT_INTERFACE(name_sys, 
