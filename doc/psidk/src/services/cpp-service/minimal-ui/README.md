...
[`proxy-sys`](../../default-apps/proxy-sys.md) calls into the service's `serveSys` action. See the next section, [Calling Other Services](../calling/), to see how services do this.
