...
if(NOT __psibase_toolchain_included)
    ...
    string(APPEND CMAKE_EXE_LINKER_FLAGS_RELEASE_INIT " -Wl,--strip-all -O3 -B${CMAKE_CURRENT_LIST_DIR}")
    string(APPEND CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO_INIT " -O3 -B${CMAKE_CURRENT_LIST_DIR}")
    string(APPEND CMAKE_EXE_LINKER_FLAGS_MINSIZEREL_INIT " -Wl,--strip-all -Os -B${CMAKE_CURRENT_LIST_DIR}")
endif()
