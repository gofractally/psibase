...
namespace psio
{
   ...
   struct flat_view_proxy_impl
   {
      ...
      constexpr auto get()
      {
         ...
         if constexpr (contains_offset_ptr<member_type>())
         {
            psio::offset_ptr* ptr = reinterpret_cast<psio::offset_ptr*>(out_ptr);
      ...
      constexpr const auto get() const
      {
         ...
         if constexpr (contains_offset_ptr<member_type>())
         {
            const psio::offset_ptr* ptr = reinterpret_cast<const psio::offset_ptr*>(out_ptr);
            return ptr->get<member_type>();
         }
         else
         {
