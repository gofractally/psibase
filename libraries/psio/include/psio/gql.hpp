...
namespace psio
{
   ...
   namespace gql
   {
      ...
      PSIO_REFLECT_TYPENAME_CUSTOM(null_t, null)
      PSIO_REFLECT_TYPENAME_CUSTOM(scalar_value, scalar)
      ...
      PSIO_REFLECT(scalar, value)
      PSIO_REFLECT(entry, key, value)
      PSIO_REFLECT(query_filter, filter, type)
      PSIO_REFLECT(query, key, alias, args, filter)
