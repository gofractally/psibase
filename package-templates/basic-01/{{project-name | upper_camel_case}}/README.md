...
For how package, service, plugin, and on-chain names relate (and when they
intentionally differ), see [Package naming](../../../doc/src/development/services/rust-service/package.md#package-naming).
