...
export type WebRtcSessionProviderProps = {
    children: ReactNode;
    /** Returns bearer token for x-wrtcsig websocket subprotocol auth. */
...
export type WebRtcSessionContextValue = {
    ...
    /** True after the first server `welcome` frame on this client instance. */
...
/**
 * Owns the x-wrtcsig websocket client for one page mount (this document load).
 * Not a Chat on-chain session (`session_id`); that lives in later join/Meet/Chat PRs.
 */
