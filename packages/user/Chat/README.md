...
This is an autogenerated README.md file for the "Chat" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Chat.psi`
...
The UI is served at the `chat` subdomain of your local psinode network.
