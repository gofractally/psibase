...
const QueryKey = {
    ...
    virtualServerCpuPricing: () => ["virtualServer", "cpuPricing"] as const,
    virtualServerNetPricing: () => ["virtualServer", "netPricing"] as const,
    virtualServerNetworkVariables: () => ["virtualServer", "networkVariables"] as const,
