...
This is an autogenerated README.md file for the "Cost" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Cost.psi`
...
The UI is served at the `cost` subdomain of your local psinode network.
