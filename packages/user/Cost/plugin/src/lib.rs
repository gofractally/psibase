...
use bindings::exports::cost::plugin::api::Guest as Api;
use bindings::exports::cost::plugin::queries::Guest as Queries;
...
bindings::export!(CostPlugin with_types_in bindings);
