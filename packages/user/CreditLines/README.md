...
This is an autogenerated README.md file for the "Credit Lines" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/CreditLines.psi`
...
The UI is served at the `credit-lines` subdomain of your local psinode network.
