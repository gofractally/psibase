...
export const InviteGuildMemberModal = ({
    ...
    const {
        mutateAsync: createGuildInvite,
        isPending: isCreatingGuildInvite,
        data: inviteString,
        error,
        isSuccess,
    ...
    const link = siblingUrl(
        null,
        getSubDomain(),
        `/invite?token=${inviteString}`,
    );
        ...
        <Dialog open={show} onOpenChange={openChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Anyone who has this link will be able to apply to the
                        guild without fee.
                    </DialogDescription>
                </DialogHeader>
                <div className="flex items-center space-x-2">
                    ...
                    <Button
                        ...
                        className="px-3"
                        onClick={() =>
                            createGuildInvite([guildAccount!, 1, true])
                        }
                    >
