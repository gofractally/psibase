...
export const Applications = () => {
    ...
    return <div className="mx-auto w-full max-w-screen-lg p-4 px-6">
        ...
        <ApplyGuildModal openChange={e => setShowGuildModal(e)} show={showGuildModal} />
        <div className="mt-3">
            ...
            ) : <EmptyBlock title="No applications" description="There are no applicants awaiting to join this guild." buttonLabel="Apply" onButtonClick={isGuildMember || isPending ? undefined : () => { setShowGuildModal(true) }} />}
        </div>
    </div>
}