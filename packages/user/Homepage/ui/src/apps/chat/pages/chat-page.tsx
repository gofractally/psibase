...
} from "@/apps/chat/components/conversation-list";
import { IncomingCallDialog } from "@/apps/chat/components/incoming-call-dialog";
...
export const ChatPage = () => {
    ...
    const openDmFromSidebar = () => {
        ...
        void openOrFocusDm(sidebarContact.account);
    };
