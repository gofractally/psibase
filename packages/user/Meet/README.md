...
This is an autogenerated README.md file for the "Meet" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Meet.psi`
...
The UI is served at the `meet` subdomain of your local psinode network.
