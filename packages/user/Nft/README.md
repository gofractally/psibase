...
This is an autogenerated README.md file for the "Nft" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Nft.psi`
...
The UI is served at the `nft` subdomain of your local psinode network.
