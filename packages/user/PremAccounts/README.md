...
This is an autogenerated README.md file for the "Prem Accounts" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/PremAccounts.psi`
...
The UI is served at the `prem-accounts` subdomain of your local psinode network.
