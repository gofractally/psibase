...
This is an autogenerated README.md file for the "Secrets" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Secrets.psi`
...
The UI is served at the `secrets` subdomain of your local psinode network.
