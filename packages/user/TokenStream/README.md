...
This is an autogenerated README.md file for the "Token Stream" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/TokenStream.psi`
...
The UI is served at the `token-stream` subdomain of your local psinode network.
