...
This is an autogenerated README.md file for the "Token Swap" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/TokenSwap.psi`
...
The UI is served at the `token-swap` subdomain of your local psinode network.
