...
Schema: type EventService_EventsHistory {
    event_db: Float!
    event_id: String!
    event_found: Boolean!
    event_service: String!
    event_supported_service: Boolean!
    event_type: String!
    event_unpack_ok: Boolean!
}
type EventService_EventsUi {
    event_db: Float!
    event_id: String!
    event_found: Boolean!
    event_service: String!
...
type EventService_EventsMerkle {
    event_db: Float!
    event_id: String!
    event_found: Boolean!
    event_service: String!
...
type EventService_Events {
    history(ids: [String!]!): [EventService_EventsHistory!]!
    ui(ids: [String!]!): [EventService_EventsUi!]!
    merkle(ids: [String!]!): [EventService_EventsMerkle!]!
}
type FooEventRecord {
    s: String!
    i: Int!
}
type FooEventRecordEdge {
    node: FooEventRecord!
    cursor: String!
}
type PageInfo {
...
type FooEventRecordConnection {
    edges: [FooEventRecordEdge!]!
    pageInfo: PageInfo!
}
type ExampleRecord {
    count: Float!
...
type ExampleRecordQuery {
    r: ExampleRecord!
}
type ExampleRecordQueryEdge {
    node: ExampleRecordQuery!
    cursor: String!
}
type ExampleRecordQueryConnection {
    edges: [ExampleRecordQueryEdge!]!
    pageInfo: PageInfo!
}
type Query {
    events: EventService_Events!
    foo2Events(first: Int last: Int before: String after: String): FooEventRecordConnection!
    exampleRecords(first: Int last: Int before: String after: String): ExampleRecordQueryConnection!
}
