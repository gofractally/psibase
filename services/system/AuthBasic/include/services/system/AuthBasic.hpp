...
namespace SystemService
{
   ...
   /// The `auth-basic` service is an auth service that can be used to authenticate actions for accounts.
   ///
   ...
   class AuthBasic : public psibase::Service<AuthBasic>
   {
     public:
      static constexpr auto service = psibase::AccountNumber("auth-basic");
      ...
      ///
      /// This action allows any user who has already set a public key using `AuthBasic::setKey`.
