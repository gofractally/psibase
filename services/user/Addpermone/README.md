...
This is an autogenerated README.md file for the "Addpermone" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Addpermone.psi`
...
The UI is served at the `addpermone` subdomain of your local psinode network.
