...
This is an autogenerated README.md file for the "Checksumtest" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Checksumtest.psi`
...
The UI is served at the `checksumtest` subdomain of your local psinode network.
