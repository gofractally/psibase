...
use bindings::exports::checksumtest::plugin::api::Guest as Api;
use bindings::exports::checksumtest::plugin::queries::Guest as Queries;
...
struct ChecksumtestPlugin;

impl Api for ChecksumtestPlugin {
    fn set_example_thing(thing: String) {
        let packed_example_thing_args = checksumtest::action_structs::setExampleThing { thing }.packed();
...
impl Queries for ChecksumtestPlugin {
...
bindings::export!(ChecksumtestPlugin with_types_in bindings);
