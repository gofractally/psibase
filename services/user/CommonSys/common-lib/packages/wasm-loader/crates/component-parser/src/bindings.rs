    ...
    pub mod component_parser {
      ...
      pub mod provider {
        ...
        const _: () = {
          ...
          #[doc(hidden)]
          #[export_name = "psibase:component-parser/provider#[constructor]component-parser"]
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_constructor_component_parser() -> i32 {
            ...
            let result0 = OwnComponentParser::new(<_ComponentParserImpl as GuestComponentParser>::new());
