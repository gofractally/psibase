...
This is an autogenerated README.md file for the "Evaluations" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Evaluations.psi`
...
The UI is served at the `evaluations` subdomain of your local psinode network.
