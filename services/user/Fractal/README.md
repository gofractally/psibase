...
This is an autogenerated README.md file for the "Fractal" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Fractal.psi`
...
The UI is served at the `fractal` subdomain of your local psinode network.
