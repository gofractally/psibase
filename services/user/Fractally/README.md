...
This is an autogenerated README.md file for the "Fractally" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Fractally.psi`
...
The UI is served at the `fractally` subdomain of your local psinode network.
