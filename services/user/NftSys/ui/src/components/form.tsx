// TODO: This file is duplicated from TokenSys' components. Both of these should be
// harmonized. The shared components version should then be updated and NftSys and TokenSys
// should then rely on it. For now, we're using this to avoid type errors and get the extra
// features we want.
