...
This is an autogenerated README.md file for the "Profiles" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Profiles.psi`
...
The UI is served at the `profiles` subdomain of your local psinode network.
