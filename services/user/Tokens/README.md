...
This is an autogenerated README.md file for the "Tokens" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/Tokens.psi`
...
The UI is served at the `tokens` subdomain of your local psinode network.
