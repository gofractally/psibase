...
This is an autogenerated README.md file for the "Web Registry" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/WebRegistry.psi`
...
The UI is served at the `web-registry` subdomain of your local psinode network.
